...
export const Main = () => {
  return (
    <div className="Main h-[90%] max-h-[90%] w-[100%] flex flex-col items-center gap-2">
      <div className="bg-gray-800 w-[70%] h-max mt-[45px] rounded-xl p-2">
        <div className="flex justify-center items-center gap-3">
          ...
          <h1 className="font-bold text-xl"><span className="text-green-400">KICK.com</span> Random Winner Picker</h1>
        </div>
      </div>
      ...
      <div className="bg-gray-800 w-[70%] h-max rounded-xl p-4 flex flex-col gap-4">
        <img src="https://www.parkgateshopping.co.uk/wp-content/uploads/2022/08/Asda1.png" />
      </div>

      <div className="bg-gray-800 w-[70%] text-lg rounded-xl p-4 font-bold text-center">
        Made with <span className="text-red-500">❤</span> by <a href="https://github.com/Paweu1412" className="text-green-400 hover:text-green-500">Paweł Nosalski</a>
      </div>
    </div>
  )
}